...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:zakootajinndb.database.windows.net,1433;Database=database;Uid=database;Pwd=Password1234;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
